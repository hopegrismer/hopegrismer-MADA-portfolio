...
subtitle: ""
author: Hope Grismer - Guoxhang contributed to this exercise! Thank you!
date: today
format:
  html:
    toc: false
...
```{r}
#| label: fig-result2
#| fig-cap: "Boxplot of Height as a Function of Favorite Pizza Flavors."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","height-pizza-boxplot.png"))
```

@fig-result2 displays a box plot of height as a function of one's favorite pizza flavor

```{r}
#| label: fig-result3
#| fig-cap: "Scatterplot of Weight v. Shoe Size."
#| echo: FALSE
knitr::include_graphics(here("starter-analysis-exercise","results","figures","shoesize-weight-scatterplot.png"))
```

@fig-result3 displays a scatter plot of weight vs. shoe size
